...
import (
	...
	"github.com/longjoy/micro-go-course/cargo/dao/inmem"
	"github.com/longjoy/micro-go-course/cargo/dao/mongo"
	"github.com/longjoy/micro-go-course/cargo/inspection"
	shipping "github.com/longjoy/micro-go-course/cargo/model"
	"github.com/longjoy/micro-go-course/cargo/service/booking"
	"github.com/longjoy/micro-go-course/cargo/service/handling"
	"github.com/longjoy/micro-go-course/cargo/service/routing"
	"github.com/longjoy/micro-go-course/cargo/service/tracking"
)
...
func main() {
	...
	srv := endpoint.New(bs, ts, hs, log.With(logger, "component", "http"))
